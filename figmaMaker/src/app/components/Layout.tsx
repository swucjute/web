        ...
        <header className="bg-white border-b border-gray-100 sticky top-0 z-30">
          <div className="flex items-center justify-between px-4 h-14">
            <div className="flex items-center gap-2">
              <Church className="text-blue-600" size={22} />
              <span className="text-base font-semibold text-gray-800">주뜨청년부</span>
            </div>
            <Link to="/more" className="flex items-center gap-2">
              <div className="text-right">
                <p className="text-xs text-gray-500">
                  {currentUser.role === 'admin' ? '관리자' : currentUser.role === 'leader' ? '리더' : '회원'}
                </p>

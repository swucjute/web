...
export function PlatformDetailPage() {
  ...
  const { getPlatformById, joinPlatform, leavePlatform, approvePlatform, rejectPlatform, approveParticipant, rejectParticipant, removeParticipant } = usePlatform();
  ...
  const canJoin = isYouthMember && isRecruiting && !isParticipant;
  const canLeave = isParticipant && isRecruiting;
  ...
  return (
    <div className="flex flex-col min-h-full bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Poster */}
        <div className="w-full bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center relative" style={{ aspectRatio: '3/4', maxHeight: 340 }}>
          {platform.posterUrl ? (
                    ...
                    {[
                      {
                        ...
                        author: '김민수',
                        date: '2024.05.10',
                        content: '오늘 첫 모임을 가졌습니다! 다들 열정이 넘치시네요. 앞으로의 활동이 기대됩니다 🔥',
                        hasImage: true,
                        likes: 12,
                        comments: 3,
                      },
                      {
                        ...
                        author: '이서연',
                        date: '2024.05.08',
                        content: '준비 회의를 진행했어요. 다음 주 활동 계획을 세웠습니다!',
                        hasImage: false,
                        likes: 8,
                        comments: 2,
                      },
                      {
                        ...
                        author: '박지훈',
                        date: '2024.05.05',
                        content: '장소 섭외 완료했습니다. 생각보다 좋은 곳을 찾았어요 👍',
                        hasImage: true,
                        likes: 15,
                        comments: 5,
                      },
                      {
                        ...
                        author: '최유진',
                        date: '2024.05.01',
                        content: '플랫폼이 승인되었습니다! 함께 해주실 분들 많이 참여해주세요 😊',
                        hasImage: false,
                        likes: 20,
                        comments: 7,
                      },

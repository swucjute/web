              ...
              <div>
                ...
                {showTestAccounts && (
                  <div className="mt-2 space-y-2">
                    {[
                      { label: '관리자', email: 'admin@church.com', password: 'admin123', badge: 'bg-red-100 text-red-700' },
                      { label: '리더', email: 'leader@church.com', password: 'leader123', badge: 'bg-blue-100 text-blue-700' },
                      { label: '회원', email: 'member@church.com', password: 'member123', badge: 'bg-green-100 text-green-700' },
                      { label: '승인대기', email: 'pending@church.com', password: 'pending123', badge: 'bg-amber-100 text-amber-700' },
                    ].map((account) => (
                      <button
                        key={account.email}
                      ...
                      >
                        <div className="text-left">
                          <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium mb-1 ${account.badge}`}>
                            {account.label}
                          </span>
